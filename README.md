...
`POST` | /user/update/<user_id/ | * and oldPassword | Update an user using the given arguments. | IsAuthenticated. The requester must be either the creator of the user or the user himself. | User: *dict*
